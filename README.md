...
VIDEO LINK
https://drive.google.com/file/d/1UwIjowV2arJBlaNN-XInMQM_DOARvbO_/view?usp=sharing
...
The user navigates to the financial planning dashboard.
The user enters financial goal parameters such as goal cost, investment duration, expected return, and inflation.
The system calculates the required SIP investment.
Investment growth charts and timeline tables are generated.
The user can download a financial report.
The chatbot assists users with financial explanations and guidance.
Example Use Case
A user planning for a wedding in 10 years can:

Enter the current goal cost.
Specify expected inflation and investment return.
View the future value of the goal.
See how much SIP investment is required monthly.
Analyze the growth of investments over time.
